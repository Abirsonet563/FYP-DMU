  ...
  reducers: {
    ...
    payOrderSuccess(state, action) {
      if (action.payload === 'Order was paid') {
        state.orderDetails.isPaid = true; // AH use this line for update the 'isPaid' property of 'orderDetails'
      }
      ...
      return state; // AH use this line for Return the updated state
    },
